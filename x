...
.containerDefault--pIXnN.selected-3LIHYU:hover .content-1x5b-n {
  background: var(--veil) var(--stars) top left;
  background-attachment: fixed;
  color: var(--blurple)
}

.containerDefault--pIXnN.selected-3LIHYU .content-1x5b-n .name-23GUGE {
  color: var(--blurple);
}
...
#app-mount .wrapper-1ucjTd:hover .content-1x5b-n {
  background-color: transparent;
}
...
#app-mount .platform-osx .guilds-1SWlCJ {
  margin-top: 60px;
}

.guilds-1SWlCJ .scroller-1Bvpku::-webkit-scrollbar {
  display: none;
}
...
#app-mount .guilds-1SWlCJ .scroller-1Bvpku .tutorialContainer-11ICd5 .listItem-2Ig28I .svg-1X37T1 {
...
.guilds-1SWlCJ .scroller-1Bvpku>.listItem-2Ig28I:first-child .pill-2uzAFe,
...
#app-mount .guilds-1SWlCJ .scroller-1Bvpku .tutorialContainer-11ICd5 .listItem-2Ig28I .wrapper-25eVIn .childWrapper-anI2G9 {
  background-color: transparent;
}
...
#app-mount .guilds-1SWlCJ .scroller-1Bvpku .tutorialContainer-11ICd5 .listItem-2Ig28I .wrapper-25eVIn.selected-bZ3Lue .homeIcon-FuNwkv {
...
#app-mount .noChannel-Z1DQK7,
.submenu-2-ysNh,
.threadSidebar-1o3BTy .chat-1cCjJ5 {
  background: var(--quatro)  var(--stars) top left !important;
  background-attachment: fixed;
}
...
#app-mount .members-1998pB .content-3YMskv {
  height: 100% !important;
}
...
.addMemberRow-3-w-9X .checkboxWrapper-SkhIWG.checked-3_4uQ9 {
  background-color: transparent !important;
...
.premiumTabItem-1QTfBr .flex-1xMQg5 {
...
.container-3auIfb[style*="background-color: rgb(114, 118, 125);"] {
  background-color: var(--blurple-sheer) !important;
}
...
.scrollerBase-289Jih::-webkit-scrollbar-track {
...
#app-mount .sadImage-2ph8SI {
  background: url(https://i.imgur.com/SClOqDlh.jpg) center/100% no-repeat;
}
...
#app-mount .item-3T2z1R.selectorButtonSelected-t5V9On {
  background: var(--blurple);
}
...
/* X. Modals */
  /* A. User Modal */
#app-mount .focusLock-Ns3yie .root-3QyAh1,
